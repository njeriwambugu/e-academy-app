...
// configure() returns this for chaining, which is why it exists as an object rather than only as named exports....
const api = { configure, open, close, closeAll, showTransient };

export { configure, open, close, closeAll, showTransient };
export default api;
